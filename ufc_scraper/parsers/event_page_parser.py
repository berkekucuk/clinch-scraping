...
from ..utils.item_factory import create_event_item, create_fight_item, create_fighter_items, create_participation_items
...
from ..utils.status_parser import parse_status
...
def parse_card(response, event_id, event_url, is_live_mode=False):
    ...
    status = parse_status(status_string)
