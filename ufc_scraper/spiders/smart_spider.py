...
class SmartSpider(scrapy.Spider):
    ...
    async def start(self):
        if self.mode == 'upcoming':
            self.logger.info("[UPCOMING MODE] Fetching upcoming events from DB...")
        ...
        elif self.mode == 'event_scan':
            self.logger.info("[EVENT SCAN MODE] Starting event pagination scrape...")
